...
monaco.editor.defineTheme("rsql-dark", {
  ...
  colors: {
    "editor.background": "#2b2839",
    "editor.foreground": "#d4d0e8",
    "editor.lineHighlightBackground": "#35314a",
    "editor.selectionBackground": "#7c3aed40",
    "editor.inactiveSelectionBackground": "#7c3aed20",
    "editorCursor.foreground": "#a78bfa",
    "editorLineNumber.foreground": "#605c78",
    "editorLineNumber.activeForeground": "#8888a0",
    "editorIndentGuide.background": "#37334a",
    "editorIndentGuide.activeBackground": "#3a3860",
    "editorGutter.background": "#2b2839",
    "editorWidget.background": "#2f2c42",
    "editorWidget.border": "#37334a",
    "editorSuggestWidget.background": "#2f2c42",
    "editorSuggestWidget.border": "#37334a",
    "editorSuggestWidget.selectedBackground": "#3b3752",
    "editorSuggestWidget.highlightForeground": "#a78bfa",
    "input.background": "#2b2839",
    "input.border": "#37334a",
