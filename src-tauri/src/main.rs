...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            drivers::pgsql::pgsql_create_role,
            drivers::pgsql::pgsql_alter_role,
            ...
            drivers::pgsql::pgsql_load_schema_table_grants,
            drivers::pgsql::pgsql_load_default_table_grants,
            drivers::pgsql::pgsql_set_schema_table_privilege,
            drivers::pgsql::pgsql_set_default_table_privilege,
            drivers::pgsql::pgsql_revoke_table_privileges,
